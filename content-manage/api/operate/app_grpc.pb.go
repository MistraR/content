...
func (c *appClient) CreateContent(ctx context.Context, in *CreateContentRequest, opts ...grpc.CallOption) (*CreateContentReply, error) {
...
func (UnimplementedAppServer) CreateContent(context.Context, *CreateContentRequest) (*CreateContentReply, error) {
...
func _App_CreateContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServer).CreateContent(ctx, req.(*CreateContentRequest))
	}
